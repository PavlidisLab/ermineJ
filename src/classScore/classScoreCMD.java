...
public class classScoreCMD {
   ...
   private void showHelp() {
      System.out
            .print( "OPTIONS\n"
                  ...
                  + Settings.BONFERONNI + " = Bonferonni,  "
                  + Settings.WESTFALLYOUNG + " = Westfall-Young (slow),  "
                  + Settings.BENJAMINIHOCHBERG
   ...
   GeneSetPvalRun analyze() throws IOException {
      ...
      GeneSetPvalRun runResult = new GeneSetPvalRun( activeProbes, settings,
            geneData, rawData, goData, geneScores, statusMessenger, "command" );
      return runResult;
   }
}
