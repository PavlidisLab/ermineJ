...
public class DataDirectoryDialog extends AppDialog {
   ...
   private void jbInit() {
      ...
      loadBrowseButton
            .addActionListener( new DataDirectoryDialog_dataDirBrowseButton_actionAdapter(
                  this ) );
...
class DataDirectoryDialog_dataDirBrowseButton_actionAdapter implements
      java.awt.event.ActionListener {
   DataDirectoryDialog adaptee;

   DataDirectoryDialog_dataDirBrowseButton_actionAdapter(
         DataDirectoryDialog adaptee ) {
...
class DataDirectoryDialog_cancelButton_actionAdapter implements
      java.awt.event.ActionListener {
   DataDirectoryDialog adaptee;
...
class DataDirectoryDialog_actionButton_actionAdapter implements
      java.awt.event.ActionListener {
   DataDirectoryDialog adaptee;
