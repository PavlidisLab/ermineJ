   ...
   private void jbInit() throws Exception {
    ...
    //  label1.setText( SOFTWARENAME );
      ...
      labelAuthors.setText( "Authors: Paul Pavlidis, Homin Lee "
            + "and Will Braynen." );
      label4.setText( "For license information , see LICENSE.txt. "
            + "Direct questions to Paul Pavlidis: pavlidis@dbmi.columbia.edu" );

      insetsPanel3.setLayout( gridLayout1 );
      gridLayout1.setRows( 6 );
      insetsPanel3.setPreferredSize( new Dimension( 350, 200 ) );
