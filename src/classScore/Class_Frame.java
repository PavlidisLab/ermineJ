...
public class Class_Frame
  ...
  public Class_Frame() {
    ...
    tabbedPane.addTab("Gene score-based", null, panel1,
                      "Calculates class scores using gene scores");
  ...
  protected Component make_Pval_Panel() {
    ...
    fileNameLabel22 = new JLabel("Probe to Functional class Mapping File",
                                 JLabel.LEFT);
    ...
    JRadioButton meanAboveButton = new JRadioButton(
        "Use Mean Above Quantile method");
    meanAboveButton.setToolTipText(
        "Use the mean above quantile of the class's gene scores.");
    ...
    num1.setToolTipText(
        "Applies to mean and quantile methods: more trials take longer.");
    ...
    quantile1.setToolTipText(
        "Applies to quantile method only. Use 50 for the median");
    ...
    pval1.setToolTipText(
        "The pvalue cutoff to use for the hypergeometric distribution class evaluation");
    ...
    class_max1.setToolTipText(
        "Classes with more members will not be considered");
    ...
    class_min1.setToolTipText(
        "Classes with fewer members will not be considered");
  ...
  /*****************************************************************************************/
  /*****************************************************************************************/
  public class TimerListener_correl
      implements ActionListener {
