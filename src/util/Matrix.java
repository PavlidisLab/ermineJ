...
public class Matrix
...

  {
    try {
      ...
      System.out.println("get_matrix_val::Cannot access " + i + ", " + j +
                         " in that matrix! Matrix has only " + rows +
  ...
  public void set_matrix_val(int i, int j, double value) {
    try {
      ...
      System.out.println("set_matrix_val::Cannot access " + i + ", " + j +
                         " in that matrix! Matrix has only " + rows +
                         " rows and " + cols + " columns");
      exception.printStackTrace();
      System.exit(1);
  ...
  public void increment_matrix_val(int i, int j) {
    try {
      ...
      System.out.println("increment_matrix_val::Cannot access " + i + ", " + j +
                         " in that matrix! Matrix has only " + rows +
                         " rows and " + cols + " columns");
      exception.printStackTrace();
      System.exit(1);
