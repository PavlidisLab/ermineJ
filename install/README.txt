...
.   - this folder contains at the top license.txt and GNU_General_Public_License.txt
lib - a folder containing jar files
bin - a folder containing JRE (Java 2 Runtime Environment) installation executable for Windows
ermineJ.data - the data folder containing sample or configuration data files.