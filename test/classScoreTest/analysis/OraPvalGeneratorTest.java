...
public class OraPvalGeneratorTest extends AbstractPvalGeneratorTest {
   ...
   public void testClassPval2() {
      ...
      GeneSetResult r = test.classPval( "GO:2", gsr.getGeneToPvalMap(),
            gsr.getProbeToPvalMap() );
   ...
   public void testClassPval1() {
      ...
      GeneSetResult r = test.classPval( "GO:1", gsr.getGeneToPvalMap(),
            gsr.getProbeToPvalMap() );
   ...
   public void testClassPval3() {
      ...
      GeneSetResult r = test.classPval( "GO:3", gsr.getGeneToPvalMap(),
            gsr.getProbeToPvalMap() );
